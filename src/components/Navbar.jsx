      ...
      <div className="container mx-auto px-4 sm:px-6 py-4">
        <div className="flex justify-between items-center gap-4">
          ...
          <div className="hidden md:flex items-center gap-6 lg:gap-8">
            ...
            <Link to="/konular" className="font-semibold text-gray-600 hover:text-emerald-600 transition-colors whitespace-nowrap">Konu Takibi</Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pt-4 border-t border-gray-100 flex flex-col gap-4 pb-2 animate-fade-in-down">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link to="/konular" onClick={() => setIsMenuOpen(false)} className="p-3 bg-gray-50 rounded-xl font-bold text-gray-700 hover:bg-emerald-50 hover:text-emerald-600 transition-colors">Konu Takibi</Link>
